...
app.get('/movies', (req, res) => {
    ...
    console.log("/movies GET request inbound")
...
app.get('/movieCompanies', (req, res) => {
    res.header({'access-control-allow-origin': '*'});
    console.log("/movieCompanies GET request inbound")

        res.status(200).send(movieCompanyData);

});

app.post('/submitReview', (req, res) => {
    console.log("server has received submission")
